...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?php echo form_open_multipart('user/editevent/' . $event['id']) ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="htm" name="htm" value="<?= $event['htm'] ?>">
                    <?= form_error('htm', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
            </div>
            <div class="form-group row">
                <label for="description" class="col-sm-2 col-form-label">Description</label>
                <textarea rows="10" class="col-sm-10 form-control " id="description" name="description"><?= $event['description'] ?></textarea>
